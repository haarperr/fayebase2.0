function Void.Util.MissionText(self, text, time)
...
function Void.Util.DrawText(self, text, font, centre, x, y, scale, r, g, b, a)
    SetTextFont(font)
    SetTextProportional(0)
    SetTextScale(scale, scale)
    SetTextColour(r, g, b, a)
...
function Void.Util.DrawText3D(self, x,y,z, text)
...
function Void.Util.RotationToDirection(self,rotation)
...
function Void.Util.ScreenRelToWorld(self,camPos,camRot,coord)

      local distance = 1000.0
      local camForward = Void.Util.RotationToDirection(self,camRot);
      ...
      local camRight = Void.Util.RotationToDirection(self,rotRight) - Void.Util.RotationToDirection(self,rotLeft);
      local camUp = Void.Util.RotationToDirection(self,rotUp) - Void.Util.RotationToDirection(self,rotDown);
...
Void.Util.GetPlayersInArea = function(coords, area)
	return enumerateInArea(Void.Util.GetPlayers(), coords, area)
end

Void.Util.GetPlayers = function()
	local maxPlayers = 24
	local players    = {}
