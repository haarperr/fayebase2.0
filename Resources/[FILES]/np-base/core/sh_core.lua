...
-- RegisterNetEvent('np-mdt:delreport')
-- AddEventHandler('np-mdt:delreport', function()
--     local src = source
--     local user = exports["np-base"]:getModule("Player"):GetUser(src)
...
-- RegisterNetEvent('np-mdt:delwarrant')
-- AddEventHandler('np-mdt:delwarrant', function()
--     local src = source
--     local user = exports["np-base"]:getModule("Player"):GetUser(src)
--     local char = user:getCurrentCharacter()
--     local hexId = user:getVar("hexid")
