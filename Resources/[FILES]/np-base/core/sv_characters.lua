...
Void.Events:AddEvent(Void.Core, Void.Core.LoginPlayer, "np-base:loginPlayer")
...
Void.Events:AddEvent(Void.Core, Void.Core.FetchPlayerCharacters, "np-base:fetchPlayerCharacters")
...
Void.Events:AddEvent(Void.Core, Void.Core.CreateCharacter, "np-base:createCharacter")
...
Void.Events:AddEvent(Void.Core, Void.Core.DeleteCharacter, "np-base:deleteCharacter")
...
Void.Events:AddEvent(Void.Core, Void.Core.SelectCharacter, "np-base:selectCharacter")