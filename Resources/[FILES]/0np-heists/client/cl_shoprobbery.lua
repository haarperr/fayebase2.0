...
RegisterNetEvent("np-robberies:HitSafes")
AddEventHandler("np-robberies:HitSafes", function()
	local storeid = isStoreRobbery()
	if storeid ~= 0 then
...
RegisterNetEvent("np-robberies:HitRegister")
AddEventHandler("np-robberies:HitRegister", function()
