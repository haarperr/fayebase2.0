...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if IsEntityDead(player) then
            ...
            local isFromBeatdown = exports["np-police"]:getIsInBeatmode()

            if isFromBeatdown then
                exports["np-police"]:setIsInBeatmode(false)
                exports["np-police"]:setBeatmodeDebuff(true)
            end
...
RegisterNetEvent('np-death:alert')
AddEventHandler('np-death:alert', function()
