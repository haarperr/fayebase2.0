...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('np-remoteCalls:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('np-remoteCalls:cl_response')
AddEventHandler('np-remoteCalls:cl_response', function(origin, callId, response)
