...
TriggerServerEvent("lrp:infinity:player:ready")

RegisterNetEvent('lrp:infinity:player:coords')
AddEventHandler('lrp:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('lrp:infinity:entity:coords')
AddEventHandler('lrp:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('lrp:infinity:entity:coords', pNetId)
