...
AddEventHandler("np-buffs:addUIBuff", function(pValues)
  ...
  print("np-buffs:addUIBuff", json.encode(buffMapUI))
  exports["np-hud"]:sendAppEvent("buffs", buffMapUI)
...
-- - swimming
-- - stress
RegisterNetEvent("np-buffs:applyBuff")
AddEventHandler("np-buffs:applyBuff", function(pKey, pBuffs)
  print("np-buffs:applyBuff", pKey, json.encode(pBuffs))
...
--   TriggerEvent("np-buffs:applyBuff", "test", { { buff = "strength", percent = 0.6, timeOverride = 10000 } })
--   --TriggerEvent("np-buffs:applyBuff", "test", { { buff = "swimming", percent = 0.33, timeOverride = 30000 } })
--   --TriggerEvent("np-buffs:applyBuff", "test", { { buff = "jobluck", percent = 0.33, timeOverride = 30000 } })
-- end, false)
