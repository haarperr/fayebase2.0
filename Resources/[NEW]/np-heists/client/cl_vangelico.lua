        ...
        if exports['np-hud']:BuffIntel() then
            exports['np-thermite']:OpenThermiteGameBuff(function(success)
                if success then
                    ...
                    TriggerServerEvent("np-doors:change-lock-state", 112, false)
...
AddEventHandler('np-heists:client_side_vangelico', function()
    local pdAmt = exports['np-duty']:LawAmount()
    if pdAmt >= 4 then
        if exports['np-inventory']:hasEnoughOfItem('thermal_charge', 1) then
...
exports["np-polytarget"]:AddBoxZone("voidrp_hit_case_1",  vector3(-627.07, -233.93, 38.06), 2, 0.7, {
    heading=305,
    --debugPoly=true,
    minZ=34.46,
    maxZ=38.46
...
exports["np-interact"]:AddPeekEntryByPolyTarget("voidrp_hit_case_1", {
    {
...
exports["np-polytarget"]:AddBoxZone("voidrp_hit_case_2",  vector3(-626.64, -234.62, 38.06), 2, 0.7, {
    heading=305,
    --debugPoly=true,
    minZ=34.46,
    maxZ=38.46
...
exports["np-interact"]:AddPeekEntryByPolyTarget("voidrp_hit_case_2", {
    {
...
exports["np-polytarget"]:AddBoxZone("voidrp_hit_case_3",  vector3(-625.87, -238.54, 38.06), 2, 0.7, {
    heading=305,
    --debugPoly=true,
    minZ=34.46,
    maxZ=38.46
...
exports["np-interact"]:AddPeekEntryByPolyTarget("voidrp_hit_case_3", {
    {
...
exports["np-polytarget"]:AddBoxZone("voidrp_hit_case_4",  vector3(-619.35, -234.4, 38.06), 2, 0.9, {
    heading=305,
    --debugPoly=true,
    minZ=34.46,
    maxZ=38.46
...
exports["np-interact"]:AddPeekEntryByPolyTarget("voidrp_hit_case_4", {
    {
...
exports["np-polytarget"]:AddBoxZone("voidrp_hit_case_5",  vector3(-617.49, -229.66, 38.06), 2, 0.7, {
    heading=35,
    -- debugPoly=true,
    minZ=34.46,
    maxZ=38.46
...
exports["np-interact"]:AddPeekEntryByPolyTarget("voidrp_hit_case_5", {
    {
...
exports["np-polytarget"]:AddBoxZone("voidrp_hit_case_6",  vector3(-619.67, -226.71, 38.06), 2, 0.7, {
    heading=35,
    -- debugPoly=true,
    minZ=34.46,
    maxZ=38.46
...
exports["np-interact"]:AddPeekEntryByPolyTarget("voidrp_hit_case_6", {
    {
...
exports["np-polytarget"]:AddBoxZone("voidrp_hit_case_7",  vector3(-624.82, -227.06, 38.06), 2, 0.7, {
    heading=305,
    --debugPoly=true,
    minZ=34.46,
    maxZ=38.46
...
exports["np-interact"]:AddPeekEntryByPolyTarget("voidrp_hit_case_7", {
    {
