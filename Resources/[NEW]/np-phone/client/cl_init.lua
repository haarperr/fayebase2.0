Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("heist_wifi_spot_1", vector3(-1358.46, -756.37, 22.3), 6.4, 7.4, {
        heading = 37,
        minZ = 21.3,
        maxZ = 23.5,
        data = {
    ...
    exports["np-polyzone"]:AddBoxZone("heist_wifi_spot_2", vector3(-1147.9, -2008.66, 13.39), 10, 10, {
        heading = 315,
        minZ = 11.99,
        maxZ = 15.99,
        data = {
    ...
    exports["np-polyzone"]:AddBoxZone("heist_wifi_spot_3", vector3(-83.88, 367.21, 112.46), 10, 10, {
        heading = 335,
        minZ = 111.26,
        maxZ = 114.26,
        data = {
    ...
    exports["np-polyzone"]:AddBoxZone("heist_wifi_spot_4", vector3(964.08, -1856.62, 31.2), 5.2, 7.2, {
      heading = 355,
      minZ = 30.0,
      maxZ = 33.0,
      data = {
