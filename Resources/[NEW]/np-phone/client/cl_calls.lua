...
AddEventHandler("phone:call:in-progress", function(pNumber, pCallId, pPayphone)
  ...
  exports['np-voice']:addPlayerToCall(pCallId)
end)
...
AddEventHandler("phone:call:inactive", function(pNumber, callId, bool)
  ...
  exports['np-voice']:removePlayerFromCall(callId)
end)
...
-- answer from phone
RegisterNUICallback("np-ui:callAccept", function(data, cb)
...
-- dial from phone
RegisterNUICallback("np-ui:callStart", function(data, cb)
...
-- end from phone
RegisterNUICallback("np-ui:callEnd", function(data, cb)
    local call_id = data.callId
...
-- init
Citizen.CreateThread(function()
  exports["np-binds"]:registerKeyMapping("","Phone", "Call Answer", "+answerPhoneCall", "-answerPhoneCall")
  RegisterCommand('+answerPhoneCall', answerPhoneCall, false)
  RegisterCommand('-answerPhoneCall', function() end, false)
  exports["np-binds"]:registerKeyMapping("","Phone", "Call End", "+endPhoneCall", "-endPhoneCall")
