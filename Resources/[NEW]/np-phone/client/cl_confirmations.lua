...
RegisterNUICallback("np-ui:genericNotificationResponse", function(data, cb)
...
function DoPhoneConfirmation(pTimeOut, pTitle, pText, pIcon, pBgColor, pCallback)
    ...
    SendReactMessage('setNotify', {
        ...
        data = {
            ...
            onAccept = "np-ui:genericNotificationResponse",
            onReject = "np-ui:genericNotificationResponse",
...
RegisterNetEvent('np-phone:client:gasOffer')
AddEventHandler('np-phone:client:gasOffer', function(data, cb)
print("halve")
