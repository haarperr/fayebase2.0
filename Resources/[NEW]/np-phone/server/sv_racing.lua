...
--         exports.ghmattimysql:execute("UPDATE racing_tracks SET races = races+1 WHERE id = '"..tonumber(Races[found].map).."'", function(results)
...
--         exports.ghmattimysql:execute("UPDATE racing_tracks SET fastest_sprint = "..tonumber(Races[found]["racers"][cid]["total"])..", fastest_sprint_name = '"..tostring(PlayerName).."' WHERE id = "..tonumber(Races[found].map).." and (fastest_sprint IS NULL or fastest_sprint > "..tonumber(Races[found]["racers"][cid]["total"])..")", function(results)
--             if results.changedRows > 0 then
--             end
--         end)
--     else
--         exports.ghmattimysql:execute("UPDATE racing_tracks SET fastest_lap = "..tonumber(Races[found]["racers"][cid]["fastest"])..", fastest_name = '"..tostring(PlayerName).."' WHERE id = "..tonumber(Races[found].map).." and (fastest_lap IS NULL or fastest_lap > "..tonumber(Races[found]["racers"][cid]["fastest"])..")", function(results)
--             if results.changedRows > 0 then
--             end
--         end)
--     end
