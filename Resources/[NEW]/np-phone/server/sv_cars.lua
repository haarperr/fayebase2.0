RPC.register("voidrp:vehicles:getPlayerVehiclesWithCoordinates", function(pSource)
...
RPC.register("voidrp:garage:vehicleSpawn", function(pSource, pModel, pCoords, pPlate)
    local coords = pCoords.param
...
RPC.register("voidrp:vehicles:respawnVehicle", function(pSource, pData)
