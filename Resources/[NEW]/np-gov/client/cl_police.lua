...
AddEventHandler("np-gov:police:showBadge", function(pSource, pInventoryData)
    ...
    Citizen.CreateThread(function()
      ...
      exports["np-interface"]:openApplication("badge", {
          show = true,
    ...
    if not GetPlayerServerId(PlayerId()) ~= pSource then
...
RegisterCommand("getbadge", function()
	local myJob = exports["isPed"]:isPed("myJob")
	if myJob == "police" or myJob == "state" or myJob == "sheriff" then
      RPC.execute("np-gov:police:getBadge")
  end
end)