...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('np-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('np-rpc:cl_response')
AddEventHandler('np-rpc:cl_response', function(origin, callId, response)
