...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('np-lib:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('np-lib:cl_response')
AddEventHandler('np-lib:cl_response', function(origin, callId, response)
