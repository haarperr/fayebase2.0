...
RegisterNetEvent('np-rpc:cl_request')
AddEventHandler('np-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('np-rpc:cl_response', src, origin, callId, response)
end)