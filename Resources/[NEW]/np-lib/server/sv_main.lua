...
RegisterNetEvent('np-lib:cl_request')
AddEventHandler('np-lib:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('np-lib:cl_response', src, origin, callId, response)
end)