...
-- RegisterNetEvent("np-hud:initHud")
-- AddEventHandler("np-hud:initHud", function()
--   print("[np-hud] Init hud...")
...
--   end
--   if hasStarted then
--     print("[np-hud] Fully started, and init.")
--     --Wait(100)
--     local initialHudSettings = GetPreferences()
--     if initialHudSettings ~= "{}" then
--       sendAppEvent("preferences", initialHudSettings)
--       exports["np-interface"]:sendAppEvent('preferences', initialHudSettings)
--       TriggerEvent("np-preferences:setPreferences", initialHudSettings)
--     end
