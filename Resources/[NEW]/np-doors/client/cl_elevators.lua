...
function OpenElevatorMenu(pElevator, pCurrentFloor, pBreachingDevice)
    ...
    exports['np-interface']:showContextMenu(reverse(elements))
end
...
RegisterInterfaceCallback('np-doors:elevator:teleport', function (data, cb)
...
RegisterInterfaceCallback('np-doors:elevator:access', function (data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
...
RegisterInterfaceCallback('np-doors:elevator:hackControlPanel', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    ...
    exports['np-interface']:openApplication('memorygame', {
...
RegisterInterfaceCallback('np-doors:elevator:completeHacking', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    ...
    exports['np-interface']:closeApplication('memorygame')
end)