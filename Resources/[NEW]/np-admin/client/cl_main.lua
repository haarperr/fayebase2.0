...
RegisterNetEvent('np-admin:client:devSpawn', function()
  local loc = {}
  loc = {
    vars = {}
  }
  ...
  exports["storage"]:set(value,"voiddevspawn")
  TriggerEvent('DoShortHudText', 'Dev spawn set at:' .. json.encode(value), 1)
end)
