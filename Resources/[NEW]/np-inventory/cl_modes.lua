...
Citizen.CreateThread(function()
	-- Register Keybinds
  exports["np-binds"]:registerKeyMapping("", "Weapons", "Switch Weapon Mode", "+switchWeaponMode", "-switchWeaponMode")
...
local function runWeaponLoop()
  ...
  Citizen.CreateThread(function()
      while running do
					TriggerEvent('np-hud:setfiremode', FireRateTypes[SELECTED_FIRE_RATE].name)
					...
					local isarmed = IsPedArmed(ply, 6)

					if not isarmed then
						TriggerEvent('np-hud:setfiremode', "OFF")
						running = false
					end
