...
RPC.register("np-business:startPurchase", function(pSource, pData)
    ...
    TriggerClientEvent("np-business:activePurchase", -1, insert)
end)

RPC.register("np-business:completePurchase", function(pSource, pData)
    ...
    local owner = exports["np-base"]:getModule("Player"):GetUser(data.charger)
    ...
    TriggerClientEvent("np-business:closePurchase", -1, insert)

    TriggerClientEvent("np-phone:SendNotify", pSource, message, "charge", businessname)
