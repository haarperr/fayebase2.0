...
RPC.register("np-business:business:GetEmploymentInformation", function(pSource)
    local user = exports["np-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("np-business:phone:GetEmploymentInformation", function(pSource)
    local user = exports["np-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("np-business:business:hasPermission", function(pSource, pBusinessId, pType)
    local hasPermission
...
RPC.register("np-business:hasPermission", function(pSource, pBusinessId, pType)
    local hasPermission
    local pAccessType = pType.param
    local user = exports["np-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("np-business:business:createRole", function(pSource, pBusinessId, pRoleName, pPermHire, pPermFire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
...
RPC.register("np-business:phone:createRole", function(pSource, pBusinessId, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
...
RPC.register("np-business:business:checkRoleExistance", function(pSource, pBusinessId, pCurRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
        local bool = false
...
RPC.register("np-business:phone:checkRoleExistance", function(pSource, pBusinessId, pCurRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local bool = false
...
RPC.register("np-business:business:editRole", function(pSource, pBusinessId, pCurRole, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank)
...
RPC.register("np-business:business:deleteRole", function(pSource, pBusinessId, pRole)
...
RPC.register("np-business:phone:deleteRole", function(pSource, pBusinessId, pRole)
...
RPC.register("np-business:business:updateEmployee", function(pSource, pCid, pBusinessId, pNewRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
...
RPC.register("np-business:phone:updateEmployee", function(pSource, pCid, pBusinessId, pNewRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("np-business:business:hireEmployee", function(pSource, pCid, pRole, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
        local employees = nil
...
RPC.register("np-business:phone:hireEmployee", function(pSource, pCid, pRole, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local employees = nil
...
RPC.register("np-business:business:fireEmployee", function(pSource, pCid, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
...
RPC.register("np-business:phone:fireEmployee", function(pSource, pCid, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("np-business:business:GetEmploymentInformationBusinessID", function(pSource, pCid, pBusinessId)
...
RPC.register("np-business:phone:GetEmploymentInformationBusinessID", function(pSource, pCid, pBusinessId)
    local userInfo = Await(SQL.execute("SELECT first_name, last_name FROM characters WHERE id = @id", {
        ["id"] = pCid
    }))
...
RPC.register("np-business:business:GetBusiness", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
    local employment = {}
...
RPC.register("np-business:phone:GetBusiness", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local employment = {}
...
RPC.register("np-business:business:GetOwner", function(pSource, pBusinessId)
...
RPC.register("np-business:business:GetBusinessRoles", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
            local allroles = {}
...
RPC.register("np-business:phone:GetBusinessRoles", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local allroles = {}
...
RPC.register("np-business:business:GetRole", function(pSource, pBusinessId, pRoleName)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
...
RPC.register("np-business:business:addEmployee", function(pSource, pCid, pRole, pBusinessId)
...
RPC.register("np-business:business:isBizOwner", function(pSource, pBusinessId)
    local user = exports["np-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("np-business:business:GetUserRole", function(pSource, pBusinessId, pCid)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
            local employees = json.decode(data[1].employees) or {}
...
RPC.register("np-business:phone:GetUserRole", function(pSource, pBusinessId, pCid)
        local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
            ["business_id"] = pBusinessId
        }))
                local employees = json.decode(data[1].employees) or {}
...
RPC.register("np-business:business:GetRolePermission", function(pSource, pBusinessId, pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId.param
    }))
            local roles = json.decode(data[1].roles) or {}
...
RPC.register("np-business:phone:GetRolePermission", function(pSource, pBusinessId, pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local roles = json.decode(data[1].roles) or {}
...
RPC.register("np-business:business:charge", function(pSource, pBusinessId, pCid, pCharger, pAmount, pComment)
    TriggerClientEvent("showPaymentNotify", -1, pBusinessId.param, pCid.param, pCharger.param, pAmount.param, pComment.param)
end)

RPC.register("np-business:phone:charge", function(pSource, pBusinessId, pCid, pCharger, pAmount)
...
RPC.register("chargeCustomer", function(pSource, pBusinessId, pCid, pComment, pCharger, pAmount, pSrc, pDate)
    ...
    local user = exports["np-base"]:getModule("Player"):GetUser(tonumber(pSrc.param))
