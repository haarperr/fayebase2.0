 local RecyclePoints = {
	{1015.4642333984,-3110.4521484375,-38.99991607666,["time"] = 0},  
	{1011.2679443359,-3110.8725585938,-38.99991607666,["time"] = 0},  
	{1005.8571777344,-3110.6271972656,-38.99991607666,["time"] = 0},  
	{995.37841796875,-3108.6293945313,-38.99991607666,["time"] = 0}, 
	{1003.0407104492,-3104.7854003906,-38.999881744385,["time"] = 0}, 
	{1008.2990112305,-3106.94140625,-38.999881744385,["time"] = 0},  
	{1010.9890136719,-3104.5573730469,-38.999881744385,["time"] = 0},  
	{1013.3607788086,-3106.8874511719,-38.999881744385,["time"] = 0},  
	{1017.8317260742,-3104.5822753906,-38.999881744385,["time"] = 0}, 
	{1019.0430297852,-3098.9851074219,-38.999881744385,["time"] = 0}, 
	{1013.7381591797,-3100.9680175781,-38.999881744385,["time"] = 0}, 
	{1009.3251342773,-3098.8120117188,-38.999881744385,["time"] = 0},  
	{1005.9111938477,-3100.9387207031,-38.999881744385,["time"] = 0}, 
	{1003.2393798828,-3093.9182128906,-38.999885559082,["time"] = 0}, 
	{1008.0280151367,-3093.384765625,-38.999885559082,["time"] = 0}, 
	{1010.8000488281,-3093.544921875,-38.999885559082,["time"] = 0}, 
	{1016.1090087891,-3095.3405761719,-38.999885559082,["time"] = 0},  
	{1018.2312011719,-3093.1293945313,-38.999885559082,["time"] = 0},  
	{1025.1221923828,-3091.4680175781,-38.999885559082,["time"] = 0}, 
	{1024.9321289063,-3096.4670410156,-38.999885559082,["time"] = 0}, 
}
...
function runRecycle()
	...
	exports["np-taskbar"]:taskBar(3000,"Picking up material")
    ...
    if math.random(1,5) == 2 then
		FreezeEntityPosition(PlayerPedId(), false)
    	TriggerEvent('player:receiveItem',"recyclablematerial", math.random(20, 30))
    else
		FreezeEntityPosition(PlayerPedId(), false)
    	TriggerEvent('player:receiveItem',"recyclablematerial", math.random(24, 36))
	end
...
Citizen.CreateThread(function()
	...
	while true do
		...
		for k,v in pairs(RecyclePoints) do
			if GetDistanceBetweenCoords(PlayerPos, v[1],v[2],v[3], true) <= 3 and not isRunningCrate then
...
RegisterNetEvent('np-recycle:enter')
AddEventHandler('np-recycle:enter', function()

		DoScreenFadeOut(1)
		Citizen.Wait(100)
		SetEntityCoords(PlayerPedId(), 1027.7348, -3101.34, -38.9999)
		SetEntityHeading(PlayerPedId(), 94.568313)
...
RegisterNetEvent('void-recycle:leave')
AddEventHandler('void-recycle:leave', function()
	CleanUpArea()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
...
RegisterNetEvent('np-trade:mats')
AddEventHandler('np-trade:mats', function()
	local isEmployed = exports["np-business"]:IsEmployedAt("recycle_center")
