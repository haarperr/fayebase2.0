...
RegisterNetEvent('void-start-mining')
AddEventHandler('void-start-mining', function()
    if voidMiningZone then
        TriggerEvent('void-civjobs-mining')
    else
...
RegisterNetEvent("void-civjobs-mining")
AddEventHandler("void-civjobs-mining", function()
        ...
        local coords = GetEntityCoords(playerPed)
            ...
            if (finished == 100) then
                ...
                if (finished == 100) then
                    ...
                    if (finished == 100) then
                        if rnd == 1 then
                            TriggerEvent('void-civjobs:mines-items')
                            pFarmed = pFarmed + 1
                        elseif rnd == 2 then
                            TriggerEvent('void-civjobs:mines-items')
                            pFarmed = pFarmed + 1
...
RegisterNetEvent('void-civjobs:mines-items', function()
