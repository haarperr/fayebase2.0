...
RegisterNetEvent("np-civjobs:package-chicken")
AddEventHandler("np-civjobs:package-chicken", function(position)
...
RegisterNetEvent("void-civjobs:process-alive_chicken")
AddEventHandler("void-civjobs:process-alive_chicken", function(position)
	if exports["np-inventory"]:hasEnoughOfItem("alive_chicken", 1) then
		...
		local finished = exports['np-taskbar']:taskBar(10000, 'Cutting the Chicken')
...
function TepnijWyjscie()
	...
	while dajdoAuta do
		...
		if DoesEntityExist(vehicle) then
			...
			ClearPedTasks(GetPlayerPed(-1))
			DeleteEntity(prop)
			TriggerEvent('player:receiveItem', "alive_chicken", 3)
		end
	end
end

RegisterNetEvent("void-chickens-start")
AddEventHandler("void-chickens-start", function()
	DoScreenFadeOut(500)
	Citizen.Wait(500)
...
RegisterNetEvent("void-chickens:sell")
AddEventHandler("void-chickens:sell", function()
	if exports["np-inventory"]:hasEnoughOfItem("packaged_chicken",2,false) then 
		...
		if (finished == 100) then
			if exports["np-inventory"]:hasEnoughOfItem("packaged_chicken",2,false) then 
				local chicken = math.random(50, 80)
...
voidChickenProcessStation1 = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("void_chicken_procces_station_1", vector3(-95.52, 6207.25, 31.03), 2, 1.8, {
        name="void_chicken_procces_station_1",
		heading=315,
		--debugPoly=true,
		minZ=28.23,
		maxZ=32.23
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "void_chicken_procces_station_1" then
        voidChickenProcessStation1 = true     
        voidProccesStation1Chickens()
		exports['np-interface']:showInteraction("[E] Process Alive Chicken")
    end
end)
...
function voidProccesStation1Chickens()
	Citizen.CreateThread(function()
        while voidChickenProcessStation1 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('void-civjobs:process-alive_chicken')
			end
		end
	end)
end
...
voidChickenProcessStation2 = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("void_chicken_procces_station_2", vector3(-100.34, 6202.42, 31.03), 1, 1.8, {
        name="void_chicken_procces_station_2",
		heading=225,
		--debugPoly=true,
		minZ=28.03,
		maxZ=32.03
...
RegisterNetEvent('np-polyzone:enter')
AddEventHandler('np-polyzone:enter', function(name)
    if name == "void_chicken_procces_station_2" then
        voidChickenProcessStation2 = true     
        voidProccesStation2Chickens()
		exports['np-interface']:showInteraction("[E] Process Alive Chicken")
    end
end)
...
function voidProccesStation2Chickens()
	Citizen.CreateThread(function()
        while voidChickenProcessStation2 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('void-civjobs:process-alive_chicken')
			end
...
voidProcessSlaughtered1 = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("void_chicken_process_1", vector3(-99.97, 6211.17, 31.03), 2, 2, {
        name="void_chicken_process_1",
		heading=315,
		--debugPoly=true,
		minZ=28.43,
		maxZ=32.43
...
RegisterNetEvent('np-polyzone:enter')
AddEventHandler('np-polyzone:enter', function(name)
    if name == "void_chicken_process_1" then
        voidProcessSlaughtered1 = true     
        voidChickenProcess1()
		exports['np-interface']:showInteraction("[E] Process Slaughtered Chicken [Bay 1]")
    end
end)
...
function voidChickenProcess1()
	Citizen.CreateThread(function()
        while voidProcessSlaughtered1 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('np-civjobs:package-chicken')
			end
		end
	end)
end
...
voidProcessSlaughtered2 = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("void_chicken_process_2", vector3(-102.1, 6208.91, 31.03), 2, 2, {
        name="void_chicken_process_2",
		heading=45,
		--debugPoly=true,
		minZ=28.43,
		maxZ=32.43
...
RegisterNetEvent('np-polyzone:enter')
AddEventHandler('np-polyzone:enter', function(name)
    if name == "void_chicken_process_2" then
        voidProcessSlaughtered2 = true     
        voidChickenProcess2()
		exports['np-interface']:showInteraction("[E] Process Slaughtered Chicken [Bay 2]")
    end
end)
...
function voidChickenProcess2()
	Citizen.CreateThread(function()
        while voidProcessSlaughtered2 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('np-civjobs:package-chicken')
			end
...
voidProcessSlaughtered3 = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("void_chicken_process_3", vector3(-104.31, 6206.7, 31.03), 2, 2, {
        name="void_chicken_process_3",
		heading=315,
		debugPoly=false,
		minZ=28.43,
		maxZ=32.43
...
RegisterNetEvent('np-polyzone:enter')
AddEventHandler('np-polyzone:enter', function(name)
    if name == "void_chicken_process_3" then
        voidProcessSlaughtered3 = true     
        voidChickenProcess3()
		exports['np-interface']:showInteraction("[E] Process Slaughtered Chicken [Bay 3]")
    end
end)
...
function voidChickenProcess3()
	Citizen.CreateThread(function()
        while voidProcessSlaughtered3 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('np-civjobs:package-chicken')
			end
...
voidChickenStart = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("void_chickens_start", vector3(2387.34, 5044.39, 46.31), 2, 2, {
        name="void_chickens_start",
		heading=310,
		--debugPoly=true,
		minZ=43.51,
		maxZ=47.51
...
RegisterNetEvent('np-polyzone:enter')
AddEventHandler('np-polyzone:enter', function(name)
    if name == "void_chickens_start" then
        voidChickenStart = true     
        voidRPChickensStart()
		exports['np-interface']:showInteraction("[E] Start Catching Chickens")
    end
end)
...
function voidRPChickensStart()
	Citizen.CreateThread(function()
        while voidChickenStart do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('void-chickens-start')
			end
		end
	end)
end
...
voidChickensSales = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("void_chicken_sales", vector3(-591.81, -892.58, 25.81), 2, 2, {
        name="void_chicken_sales",
		heading=0,
		--debugPoly=true,
		minZ=23.81,
		maxZ=27.81
...
RegisterNetEvent('np-polyzone:enter')
AddEventHandler('np-polyzone:enter', function(name)
    if name == "void_chicken_sales" then
        voidChickensSales = true     
        voidChickensSalesFunction()
		exports['np-interface']:showInteraction("[E] Sell Packaged Chickens")
    end
end)
...
function voidChickensSalesFunction()
	Citizen.CreateThread(function()
        while voidChickensSales do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('void-chickens:sell')
			end
		end
	end)
end