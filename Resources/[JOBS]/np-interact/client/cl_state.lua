...
function IsMenuWanted(pMenu, pEntity)
    return pMenu == 'general' or pMenu == 'peds' and pEntity == 1 or pMenu == 'vehicles' and pEntity == 2 or pMenu == 'objects' and pEntity == 3 or pMenu =='news' and isNews or pMenu == 'k9' and isPolice or isSheriff or isRanger or isState or pMenu == 'judge' and isJudge
end
...
function getVehicleOwner(pEntity)
  ...
  local vin = exports['np-vehicledegrade']:GetVehicleIdentifier(pEntity)
...
AddEventHandler("np-jobmanager:playerBecameJob", function(job, name, notify)
    ...
    if isRanger and job ~= "ranger" then isRanger = false end
    ...
    if job == "ranger" then isRanger = true end
