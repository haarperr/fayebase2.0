...
RegisterNetEvent('np-illegalactivities:check_for_illegal_cash')
AddEventHandler('np-illegalactivities:check_for_illegal_cash', function()
    if exports['np-inventory']:hasEnoughOfItem('cashroll', 5) then
        TriggerServerEvent('np-illegalactivities:oxy_payment', math.random(75, 100))
        TriggerEvent('inventory:removeItem', 'cashroll', 5)
    elseif exports['np-inventory']:hasEnoughOfItem('band', 5) then
        TriggerEvent('inventory:removeItem', 'band', 5)
        TriggerServerEvent('np-illegalactivities:oxy_payment', math.random(456, 786))
    end
end)

-- Shibiz n Dat -- 

RegisterNetEvent('np-illegalactivities:location')
AddEventHandler('np-illegalactivities:location', function()
    if EvanOxyLocation1 then
        TriggerEvent('np-illegalactivities:sell_package')
        print('[EVAN 1] - VOID RP OXY RUNS - MADE BY Evan')
        TriggerEvent('np-illegalactivities:call_cops')
    elseif EvanOxyLocation2 then
        print('[EVAN 2] - VOID RP OXY RUNS - MADE BY Evan')
        TriggerEvent('np-illegalactivities:sell_package_location2')
        TriggerEvent('np-illegalactivities:call_cops')
    elseif EvanOxyLocation3 then
        print('[EVAN 3] - VOID RP OXY RUNS - MADE BY Evan')
        TriggerEvent('np-illegalactivities:sell_package_location3')
        TriggerEvent('np-illegalactivities:call_cops')
    end
end)
...
RegisterNetEvent('np-oxy:start_run')
AddEventHandler('np-oxy:start_run', function()
    if not StartedOxyRun then
        if exports['np-inventory']:hasEnoughOfItem('vpnxj', 1) then
            exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", 'Checked in as Oxy Runner.')
            StartedOxyRun = true
            Citizen.Wait(math.random(1, 180000))
            TriggerEvent('np-oxyrun:get_packagelocation')
            Citzen.Wait(180000)
            StartedOxyRun = false
        else
...
RegisterNetEvent('np-oxy:clock_out')
AddEventHandler('np-oxy:clock_out', function()
...
RegisterNetEvent('np-oxyrun:get_packagelocation')
AddEventHandler('np-oxyrun:get_packagelocation', function()
    local PedLoc = math.random(1, 3)
    if PedLoc == 1 then
        exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", 'Head towards the area on your GPS and grab the packages.')
        LocationPickup1 = true
        TriggerEvent('np-illegalactivities:create_location1_oxy_ped_and_blip')
    elseif PedLoc == 2 then
        exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", 'Head towards the area on your GPS and grab the packages.')
        LocationPickup2 = true
        TriggerEvent('np-illegalactivities:create_location2_oxy_ped_and_blip')
    elseif PedLoc == 3 then
        exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", 'Head towards the area on your GPS and grab the packages.')
        LocationPickup3 = true
        TriggerEvent('np-illegalactivities:create_location3_oxy_ped_and_blip')
    end
end)

RegisterNetEvent('np-illegalactivities:call_cops')
AddEventHandler('np-illegalactivities:call_cops', function()
...
RegisterNetEvent('np-illegalactivities:go_to_sell_location')
AddEventHandler('np-illegalactivities:go_to_sell_location', function()
    ...
    if EvanOxySellLocations == 1 then
        ...
        exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", 'Head over to North Rockford Drive.') 
    ...
    elseif EvanOxySellLocations == 2 then
        ...
        exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", 'Head over to Seaview Road.') 
        EvanFirstLocalStarted = false
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("evan_oxy_location_inside_1", vector3(-1931.29, 327.56, 89.75), 25, 40, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "evan_oxy_location_inside_1" then
        ...
        if EvanOxyLocation1 and not EvanFirstLocalStarted and HeadingToNorthRockford then
            ...
            TriggerEvent('np-illegalactivities:ped_to_sellpoint1')
        else
...
RegisterNetEvent('np-illegalactivities:evan_oxyrun:getpackages_1')
AddEventHandler('np-illegalactivities:evan_oxyrun:getpackages_1', function()
    if not exports['np-inventory']:hasEnoughOfItem('darkmarketpackage', 1) then
        if CanCollectPackageLocation1 then
            ...
            exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", '('..PackagesCollected..'/5) Packages Collected') 
            if PackagesCollected == 5 then
                Citizen.Wait(5000)
                DeleteEntity(created_ped)
                LocationPickup1 = false
                PackagesCollected = 0
                TriggerEvent('np-illegalactivities:go_to_sell_location')
                OnTheWayToDropoffLocation1 = true
            else
                Citizen.Wait(10000)
    ...
    elseif exports['np-inventory']:hasEnoughOfItem('darkmarketpackage', 1) then
        TriggerEvent('DoLongHudText', 'You aint quite learnt how to multitask yet', 2)
    end
end)

RegisterNetEvent('np-illegalactivities:create_location1_oxy_ped_and_blip')
AddEventHandler('np-illegalactivities:create_location1_oxy_ped_and_blip', function()
...
exports["np-polytarget"]:AddBoxZone("evan_oxyruns_ped_1", vector3(559.0, -1037.3, 31.34), 0.8, 0.8, {
    heading=0,
    minZ=28.74,
    maxZ=32.74
})

exports["np-interact"]:AddPeekEntryByPolyTarget("evan_oxyruns_ped_1", {{
    event = "np-illegalactivities:evan_oxyrun:getpackages_1",
...
RegisterNetEvent('np-illegalactivities:sell_package')
AddEventHandler('np-illegalactivities:sell_package', function()
		...
		if licensePlate == setOxyVehicle then
            if OnTheWayToDropoffLocation1 then
                if CanSell2 or CanSell3 or CanSell1 then
                    if exports['np-inventory']:hasEnoughOfItem('darkmarketpackage', 1) then
                        HeadingToNorthRockford = false
                        TriggerEvent('inventory:removeItem', 'darkmarketpackage', 1)
                        TriggerServerEvent('np-illegalactivities:oxy_payment', math.random(88, 175))
                        TriggerEvent('player:receiveItem', 'oxy', 2)
                        TriggerEvent('np-illegalactivities:check_for_illegal_cash')
                        PackagesToDrop = PackagesToDrop + 1 
                        exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", '('..PackagesToDrop..'/5) Packages Dropped Off.') 
...
RegisterNetEvent('np-illegalactivities:sell_point_1_coords')
AddEventHandler('np-illegalactivities:sell_point_1_coords', function()
...
RegisterNetEvent('np-illegalactivities:ped_to_sellpoint1')
AddEventHandler('np-illegalactivities:ped_to_sellpoint1', function()
    EvanFirstLocalStarted = true

    local radius = 1.00
    TriggerEvent('np-illegalactivities:sell_point_1_coords')
    ...
    if PackagesToDrop == 5 then
        ...
        print(PackagesToDrop)
        Citizen.Wait(13000)
        exports["np-phone"]:DoPhoneNotification("home-screen", "CURRENT", 'The Job Offer Was Completed.') 
    else
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("evan_oxy_location_inside_2", vector3(1807.56, 4577.12, 36.14), 25, 30, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "evan_oxy_location_inside_2" then
        ...
        if EvanOxyLocation2 and not EvanFirstLocalStarted and HeadingToEastJoshua then
            ...
            TriggerEvent('np-illegalactivities:ped_to_sellpoint2')
        else
...
RegisterNetEvent('np-illegalactivities:evan_oxyrun:getpackages_2')
AddEventHandler('np-illegalactivities:evan_oxyrun:getpackages_2', function()
    if not exports['np-inventory']:hasEnoughOfItem('darkmarketpackage', 1) then
...
RegisterNetEvent('np-illegalactivities:create_location2_oxy_ped_and_blip')
AddEventHandler('np-illegalactivities:create_location2_oxy_ped_and_blip', function()
    modelHash = GetHashKey("csb_ramp_gang")
    RequestModel(modelHash)
    while not HasModelLoaded(modelHash) do
        Wait(1)
...
exports["np-polytarget"]:AddBoxZone("evan_oxyruns_ped_2", vector3(-1024.59, 2892.2, 6.4), 0.8, 0.8, {
    heading=0,
    --debugPoly=true,
    minZ=3.4,
    maxZ=7.4
...
exports["np-interact"]:AddPeekEntryByPolyTarget("evan_oxyruns_ped_2", {{
    event = "np-illegalactivities:evan_oxyrun:getpackages_2",
...
RegisterNetEvent('np-illegalactivities:sell_package_location2')
AddEventHandler('np-illegalactivities:sell_package_location2', function()
    local OxyChance = math.random(1, 2)
    coordA = GetEntityCoords(PlayerPedId(), 1)
	coordB = GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 100.0, 0.0)
	vehicle = getVehicleInDirection(coordA, coordB)
...
RegisterNetEvent('np-illegalactivities:sell_point_2_coords')
AddEventHandler('np-illegalactivities:sell_point_2_coords', function()
    local OxyCoords = math.random(3)
    if OxyCoords == 1 then
...
RegisterNetEvent('np-illegalactivities:ped_to_sellpoint2')
AddEventHandler('np-illegalactivities:ped_to_sellpoint2', function()
    EvanFirstLocalStarted = true

    local radius = 1.00
    TriggerEvent('np-illegalactivities:sell_point_2_coords')
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("evan_oxy_location_inside_3", vector3(673.85, 197.74, 94.65), 25, 40.4, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "evan_oxy_location_inside_3" then
        ...
        if EvanOxyLocation3 and not EvanFirstLocalStarted and HeadingToClinton then
            ...
            TriggerEvent('np-illegalactivities:ped_to_sellpoint3')
        else
...
RegisterNetEvent('np-illegalactivities:evan_oxyrun:getpackages_3')
AddEventHandler('np-illegalactivities:evan_oxyrun:getpackages_3', function()
    if not exports['np-inventory']:hasEnoughOfItem('darkmarketpackage', 1) then
...
RegisterNetEvent('np-illegalactivities:create_location3_oxy_ped_and_blip')
AddEventHandler('np-illegalactivities:create_location3_oxy_ped_and_blip', function()
    modelHash = GetHashKey("csb_ramp_gang")
    RequestModel(modelHash)
    while not HasModelLoaded(modelHash) do
        Wait(1)
...
exports["np-polytarget"]:AddBoxZone("evan_oxyruns_ped_3", vector3(1161.24, -1383.72, 34.74), 0.8, 0.8, {
    heading=0,
    --debugPoly=true,
    minZ=31.74,
    maxZ=35.74
...
exports["np-interact"]:AddPeekEntryByPolyTarget("evan_oxyruns_ped_3", {{
    event = "np-illegalactivities:evan_oxyrun:getpackages_3",
...
RegisterNetEvent('np-illegalactivities:sell_package_location3')
AddEventHandler('np-illegalactivities:sell_package_location3', function()
    local OxyChance = math.random(1, 2)
    coordA = GetEntityCoords(PlayerPedId(), 1)
	coordB = GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 100.0, 0.0)
	vehicle = getVehicleInDirection(coordA, coordB)
...
RegisterNetEvent('np-illegalactivities:ped_to_sellpoint3')
AddEventHandler('np-illegalactivities:ped_to_sellpoint3', function()
    EvanFirstLocalStarted = true
    ...
    data = {
        {
            ...
            icon = "hand-holding",    
            event = "np-illegalactivities:location",
            parameters = {}
        }
    },
    options = {
