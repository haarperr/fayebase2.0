...
Config.Zones = {
	garages = {
		...
		BoxZone:Create(vector3(-1783.104, 464.1305, 128.3198), 5, 10.6, {
			name="garagemafia",
			heading=278.84527587891,
			-- debugPoly=true,
		}),
		BoxZone:Create(vector3(-23.73102, -1094.652, 27.30523), 5, 5, {
			name="garagepdm",
			heading=338.1188659668,
			-- debugPoly=true,
		}),
}
}