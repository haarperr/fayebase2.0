...
local BusinessNames = {
	...
	["realtor"] = "Los Santos Real Estate",
...
RegisterNetEvent('lucity-phone:fix-dead')
AddEventHandler('lucity-phone:fix-dead', function()
  dead = false
end)