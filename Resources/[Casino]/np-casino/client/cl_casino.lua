...
AddEventHandler("np-casino:purchaseMembership", function()
  ...
  local jobAccess = exports["np-business"]:IsEmployedAt("casino")
...
AddEventHandler("np-casino:purchaseMembershipCard", function()
  RPC.execute("np-casino:purchaseMembershipCard")
end)
...
-- end, false)
-- Citizen.CreateThread(function()
--   exports["np-binds"]:registerKeyMapping("", "Casino", "Add Coords", "+addCasinoCoords", "-addCasinoCoords")
-- end)
