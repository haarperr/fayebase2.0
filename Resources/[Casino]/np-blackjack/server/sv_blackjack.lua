...
RPC.register("np-blackjack:getDealerPedSeeds", function()
    ...
    if gameId ~= nil and betAmount ~= nil and chairId ~= nil then 
        ...
        if not blackjackGameInProgress[gameId] then
            if tonumber(betAmount) then
                ...
                if betAmount > 0 then
                    local ChipCount = exports["np-casino"]:ChipCount(src)
...
AddEventHandler("Blackjack:hitBlackjack", function(gameId, nextCardCount, UseChipsResult)
    print(gameId, nextCardCount, UseChipsResult)
                                        ...
                                        if currentHand ~= nil then
                                            if currentHand <= 21 then
                                                ...
                                                if dealerHand > 21 then
                                                    ...
                                                    exports["np-casino"]:giveChips(source, potentialWinAmount)
                                                ...
                                                elseif currentHand == dealerHand then
                                                    ...
                                                    exports["np-casino"]:giveChips(source, potentialPushAmount)
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
