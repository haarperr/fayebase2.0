...
Housing.interactionlist = {
    [1] = {
        ...
        ["event"] = {
            ["generalUse"] = {"",""},
            ["housingMain"] = {"Open Stash.","housing:inventory"},
            ["housingSecondary"] = {"",""},
        }
    },
    [2] = {
        ...
        ["event"] = {
            ["generalUse"] = {"",""},
            ["housingMain"] = {"",""},
            ["housingMain"] = {"Change Clothes","doClothing"},
			["housingSecondary"] = {"Logout / Exit","housing:charLogout"},
        }
    },
    [3] = {
        ...
        ["event"] = {
            ["generalUse"] = {"",""},
            ["housingMain"] = {"Exit","housing:internalBackdoor"},
            ["housingSecondary"] = {"",""},
        }
    },
    [4] = {
        ...
        ["event"] = {
            ["generalUse"] = {"",""},
            ["housingMain"] = {"Exit","housing:exitFrontDoor"},
            ["housingSecondary"] = {"",""},
        }
    },
    [5] = {
        ...
        ["event"] = {
            ["generalUse"] = {"",""},
            ["housingMain"] = {"Open Crafting.","housing:crafting"},
            ["housingSecondary"] = {"",""},
        }
    }
}
...
RegisterNetEvent('housing:phoneContract', function()
    local user = exports["np-base"]:GetModule("LocalPlayer")
    local isClose ,hID = exports["np-housing"]:isNearProperty()
    local preoprtyInfo = exports["np-housing"]:getHouse(hID)
    local name = {
        first_name =  user.first_name , 
        last_name = user.last_name,
        id = user.cid,
    }
    TriggerEvent("chatMessage", "Housing App", 8, getContractText(name , 600 ,preoprtyInfo.street, preoprtyInfo.street)  )
end)
