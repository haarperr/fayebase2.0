...
RegisterNUICallback("np-ui:pingSend", function(data, cb)
...
RegisterNUICallback("np-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("np-ui:pingReject", function(data, cb)
