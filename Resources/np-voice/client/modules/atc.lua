...
function LoadATCModule()
    ...
    exports["np-binds"]:registerKeyMapping("", "ATC", "Push-To-Talk", "+transmitToATCRadio", "-transmitToATCRadio")
    ...
    exports["np-binds"]:registerKeyMapping("", "ATC", "On / Off", "+toggleATCRadioState", "-toggleATCRadioState")
    ...
    exports["np-binds"]:registerKeyMapping("", "ATC", "Volume Up", "+increaseATCRadioVolume", "-increaseATCRadioVolume")
    ...
    exports["np-binds"]:registerKeyMapping("", "ATC", "Volume Down", "+decreaseATCRadioVolume", "-decreaseATCRadioVolume")
