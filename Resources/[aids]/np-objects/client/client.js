;(function () {
    ...
    !(function () {
      ...
      setImmediate(async () => {
        ...
        Number(_0x36aece.length) === 0 && emitNet('lucityrp-objects:requestObjects')
      })
      onNet('lucityrp-objects:loadObjects', async (_0xe9ddb4) => {
        console.log('[lucityrp-objects] Load Objects')
        let _0x4ab09a = _0xe9ddb4
        Object.entries(_0x4ab09a).forEach(([_0x12c7d5, _0x331d4d]) => {
          _0x491670(_0x331d4d)
        })
      })
      onNet('np:objects:prepareNewObject', async (_0x29ed64) => {
        _0x491670(_0x29ed64)
      })
      on('lucityrp-polyzone:enter', async (_0x46614c, _0x2b0f68) => {
        ...
        console.log('[lucityrp-objects] Entered zone, load objects in distance.')
      ...
      on('lucityrp-polyzone:exit', (_0x329570, _0x2b3c55) => {
        ...
        console.log('[lucityrp-objects] Left zone, unload objects in distance.')
      ...
      onNet('lucityrp-objects:clearObjects', (_0x469f66) => {
      ...
      onNet('lucityrp-objects:updateObjects', (_0xacd038) => {
      ...
      async function _0x491670(_0x2d06c6) {
        console.log('[lucityrp-objects] Adding object: ', _0x2d06c6)
        let _0x1194f7 = {
      ...
      function _0x3712a8(_0x4b77ba) {
        let _0x5f588f = RPC.execute('lucityrp-objects:DeleteObject', _0x4b77ba)
        return _0x5f588f
      }
      _0x2df2bb.g.exports('DelObject', _0x3712a8)
      function _0x3fc7e3(_0x45e806, _0x4befc3) {
        RPC.execute('lucityrp-objects:UpdateObject', _0x45e806, _0x4befc3)
      }
      ...
      RegisterCommand(
        ...
        (_0x37a992, _0x4114dc, _0x5d60b5) => {
          ...
          console.log('[lucityrp-objects] getObject return: ', _0x51a571)
        },
        false
      )
      RegisterCommand(
    ...
    !(function () {
      ...
      function _0x4cef94(_0x381b0f) {
        emitNet(
          'lucityrp-objects:prepareObject',
          _0x4f06bd,
          _0x381b0f.x,
          _0x381b0f.y,
          _0x381b0f.z,
