!(function () {
    'use strict'
    onNet('lucityrp-objects:requestObjects', async () => {
      ...
      emitNet('lucityrp-objects:loadObjects', _0x3f784e, _0x2e66af)
    })
    onNet(
      ...
      async (
        ...
        emitNet('np:objects:prepareNewObject', -1, _0x5aa71c)
      }
    )
    RPC.register(
      ...
      async (
        ...
        return emitNet('np:objects:prepareNewObject', -1, _0x588249), true
      }
    )
    RPC.register('lucityrp-objects:DeleteObject', async (_0x1d3045, _0x2078ee) => {
      ...
      return (
        !!(await SQL.execute('DELETE FROM __objects WHERE id = @id', {
          id: _0x2078ee,
        })) && (emitNet('lucityrp-objects:clearObjects', -1, _0x1edca6), true)
      )
    })
    RPC.register(
      'lucityrp-objects:UpdateObject',
      async (_0x2f99f7, _0x49819b, _0x25e634) => {
        ...
        return emitNet('lucityrp-objects:updateObjects', -1, _0x201f32), true
      }
    )
  })()
