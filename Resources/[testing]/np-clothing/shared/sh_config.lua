...
Config.Debug = true
Config.UseTarget = false -- true = Target Eye (Requires: np-target), false = Polyzones (Requires: PolyZone)
Config.ContextMenu = 'np-menu' -- Script name for the context menu
Config.ClothingPrice = 250
...
Config.ClothingRooms = {
    ...
    { 
        ['Job'] = 'ems', 
        ['IsGang'] = false, 
        ['Coords'] = vector3(318.15, -599.35, 43.29), 
        ['Width'] = 2,
        ['Length'] = 2,
    },
    { 
