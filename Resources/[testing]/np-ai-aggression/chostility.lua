...
function AlertSuspicious()
  ...
  --   }
  -- })
  exports["np-dispatch"]:dispatchadd(dispatchCode, "Suspicious Activity")
  ...
  if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
    ...
    exports["np-dispatch"]:dispatch(dispatchCode, "Suspicious Activity", vehicleData.plate, plyPos, vehicleData.model)
  end
end
...
function DrugSale()
  ...
  if checkedLocations() then
    ...
    --   }
    -- })
    exports["np-dispatch"]:dispatchadd(dispatchCode, "Drug Trafficking")
    Wait(math.random(5000,15000))
    ...
    if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
      ...
      --   }
      -- })
      exports["np-dispatch"]:dispatch(dispatchCode, "Drug Trafficking", vehicleData.plate, plyPos, vehicleData.model)
    end
end
...
function DrugUse()
  ...
  if checkedLocations() then
    ...
    --   }
    -- })
    exports["np-dispatch"]:dispatchadd(dispatchCode, "Illegal Substance Use")
    ...
    if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
      ...
      --   }
      -- })
      exports["np-dispatch"]:dispatch(dispatchCode, "Illegal Substance Use", vehicleData.plate, plyPos, vehicleData.model)
    end
end
...
function CarCrash()
  ...
  exports["np-dispatch"]:dispatchadd(dispatchCode, "Car Crash")
  ...
  if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle and job == "police" then
    ...
    exports["np-dispatch"]:dispatch(dispatchCode, "Car Crash", vehicleData.plate, plyPos, vehicleData.model)
  end
end
...
function AlertDeath()
  ...
  --   }
  -- })
  exports["np-dispatch"]:dispatchadd(dispatchCode, "player dead") -- changer later
end
...
function AlertFight()
  ...
  exports["np-dispatch"]:dispatchadd(dispatchCode, "Street Fight") 
  Wait(math.random(5000,15000))
  ...
  if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
    ...
    --   }
    -- })
    exports["np-dispatch"]:dispatch(dispatchCode, "Street Fight", vehicleData.plate, plyPos, vehicleData.model)
...
function AlertDeadlyWeapon()
  ...
  --   }
  -- })
  exports["np-dispatch"]:dispatchadd(dispatchCode, "Deadly Weapon") 
end
...
function AlertCheckLockpick(object)
    ...
    if not DoesEntityExist(targetVehicle) then
      ...
      --   }
      -- })
      exports["np-dispatch"]:dispatchadd(dispatchCode, "Stealing Vehicle") 
      return
    end
