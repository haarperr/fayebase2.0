...
local InteractStartCorner = {
  ...
  options = {
    ...
    isEnabled = function(pEntity, pContext)
      local hasWeed = exports['np-inventory']:hasEnoughOfItem('weedq', 1, false, true)
...
Citizen.CreateThread(function()
  exports['np-interact']:AddPeekEntryByEntityType(InteractCornerSell.group, InteractCornerSell.data, InteractCornerSell.options)
...
AddEventHandler('np-weed:startCornering', function(pContext, pEntity)
  ...
  local canCorner, message = RPC.execute('np-weed:startCorner', CurrentCornerCoords)
  ...
  Citizen.CreateThread(function()
    ...
    while CurrentlyCornering do
      ...
      if not foundPed then
        ...
        local result = RPC.execute('np-weed:cornerPed', coords, NetworkGetNetworkIdFromEntity(foundPed), NetworkGetNetworkIdFromEntity(CurrentCornerVehicle))
    end
...
AddEventHandler('np-weed:cornerSale', function(pContext, pEntity)
  ...
  local hasBaggies = exports['np-inventory']:hasEnoughOfItem('weedq', 1, true)
  ...
  if didSale then
    ...
    if rndAmt == 1 and exports['np-inventory']:hasEnoughOfItem('weedq', 1) then
        TriggerEvent('money:clean')
        TriggerEvent('inventory:removeItem', 'weedq', 1)
      elseif rndAmt == 2 and exports['np-inventory']:hasEnoughOfItem('weedq', 3) then
        TriggerEvent('money:clean')
        TriggerEvent('money:clean')
        TriggerEvent('money:clean')
        TriggerEvent('inventory:removeItem', 'weedq', 1)
        TriggerEvent('inventory:removeItem', 'weedq', 1)
        TriggerEvent('inventory:removeItem', 'weedq', 1)
      elseif rndAmt == 3 and exports['np-inventory']:hasEnoughOfItem('weedq', 2) then
        TriggerEvent('money:clean')
        TriggerEvent('money:clean')
        TriggerEvent('inventory:removeItem', 'weedq', 1)
        TriggerEvent('inventory:removeItem', 'weedq', 1)
